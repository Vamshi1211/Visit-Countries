        ...
        <div className="countries-container">
          ...
          <ul className="countries-list-container">
            {countriesList.map(eachItem => {
              ...
              const onClickVisitedClicked = () => {
                this.onClickVisit(id)
              }
              return (
                <li key={id} className="countries-list-item-container">
        ...
        <div className="visited-countries-container">
          ...
          {filteredData.length > 0 ? (
            ...
            <div className="not-found-container">
              <p className="not-found-heading">No Countries Visited Yet!</p>
            </div>
          )}
        </div>
      </div>
